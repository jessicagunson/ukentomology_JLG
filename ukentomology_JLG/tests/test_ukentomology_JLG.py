...
def test_entData_shape():
    actual = entData.shape
    expected = (214, 9)
    assert actual == expected

def test_entData_countLMNH():
    actual = sum(entData.institution == 'LMNH')
    expected = 100
    assert actual == expected

def test_entData_countRAMM():
    actual = sum(entData.institution == 'RAMM')
    expected = 114
    assert actual == expected
